  ...
  const projects = [
    {
      ...
      description: "Modern, interactive React CV application. (Desktop-Optimized Layout)",
    ...
    },
    {
      ...
      description: "Rev up with our car club. (Desktop-Optimized Layout)",
    ...
    },
    {
      ...
      description: "Discover my artsy space-themed React portfolio. (Fully responsive design for all devices)",
      demoLink: "https://portfolio-ii-contact-form.onrender.com/",
      repoLink: "https://github.com/Retr0verse/Portfolio-II/",
      imgUrl: projImg7,
    },
    {
      title: "HTML Accessibility Documentation (Fully responsive design for all devices)",
    ...
    {
      title: "Calculator (Desktop-Optimized Layout)",
    ...
    {
      title: "Opposite Etch-a-Sketch (Desktop-Optimized Layout)",
